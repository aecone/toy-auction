...
INSERT INTO toy_listing (initial_price, category, name, start_age, end_age, secret_min_price, closing_datetime, increment, start_datetime, username) VALUES
                                                                                                                                                         (20.00, 'Action Figure', 'Spiderman Action Figure', 5, 10, 15.00, '2024-05-10 12:00:00', 2.00, '2024-05-03 12:00:00', 'john_doe'),
                                                                                                                                                         (15.00, 'Board Game', 'Monopoly', 8, 99, 10.00, '2024-05-15 18:00:00', 1.00, '2024-05-05 09:00:00', 'jane_smith'),
                                                                                                                                                         (10.00, 'Stuffed Animal', 'Teddy Bear', 0, 5, 7.00, '2024-05-08 15:00:00', 0.50, '2024-05-01 10:00:00', 'bob_jones');
...
INSERT INTO alert (alert_id, name, max_price, category, min_price, age_range, username) VALUES
                                                                                            ('AL001', 'Spiderman Action Figure Alert', 30.00, 'Action Figure', 10.00, '5-10', 'john_doe'),
                                                                                            ('AL002', 'Monopoly Alert', 20.00, 'Board Game', 8.00, '8+', 'jane_smith');

-- Mock data for report table
INSERT INTO report (report_id, date, total_earnings, admin_id, earnings_per, best_selling) VALUES
                                                                                               ("id1", '2024-05-10', 75.00, 'admin', 25.00, 'Spiderman Action Figure'),
...
INSERT INTO question (question_text, q_id, username) VALUES
                                                         ...
                                                         ('Is this board game suitable for adults?', '5', 'jane_smith');
...
INSERT INTO answer (q_id, c_id, answer_text) VALUES
                                                 ...
                                                 ('5', 'sammy', 'Yes, this board game is suitable for adults.');